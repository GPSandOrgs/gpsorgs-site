...
<section class="page-title"><h1>Community</h1><p class="lede">A shared noticeboard for the community. Announcements and calls are posted as they come in: if you have something the community should know about, <a href="/contact">send it to us</a>. The <a href="/readings">reading list</a> has its own page.</p>
...
""")
# The reading list. Add new references here; the page is generated from this block and
# each entry gets a Google Scholar link keyed on its title.
READINGS_SHELVES = """
...
pages["readings.html"] = (
    ...
    '<section class="page-title"><h1>Readings</h1><p class="lede">%s</p></section>\n%s\n'
      % (READINGS_LEDE, scholarize(READINGS_SHELVES)))
